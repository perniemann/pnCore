...
description: "Programmatic video from HTML (data-start/duration, Puppeteer+FFmpeg). Use when pixel-exact repeatable demos or social cuts beat generative T2V — not for pn-generative-video-pipelines."
---
