...
export const resourceDefs: {
  ...
  },
  {
    ...
    description:
      "What pnCore gates in a downstream project (chat workflow + opt-in git trailer hooks/CI) versus this repo’s land-on-main path; MCP never owns the GitHub Merge button",
