...
export const resourceDefs = [
    ...
    },
    {
        ...
        description: "EVAL.yaml skill evaluation convention: with/without-skill scenarios, Accuracy×Efficiency quadrants, scaffolder",
    ...
    },
    {
        ...
        description: "Local-agent EVAL.yaml backfill contract: priority order, batch size, hard rules, ranked list via npm run list:eval-backfill",
    ...
    },
    {
        ...
        description: "Diagram quality floor: Mermaid vs editorial HTML tracks, density, type picker, D-01–D-10 ship gate, accTitle/accDescr, brand tokens from .pncore-design.md",
    ...
    },
    {
        ...
        description: "Task subagent_type and model-tier routing; parallel review panel for high-risk slices; explore vs best-of-N vs specialist parallel",
    ...
    },
    {
        ...
        description: "Loop engineering 2026: taxonomy, Karpathy/Machina patterns, subagent model routing, Fable long_horizon tier, Cursor /loop bridge",
    ...
    },
    {
        ...
        description: "Starter dev loop templates (CI babysitter, validate-until-green, escalation queue) with STATE schema",
