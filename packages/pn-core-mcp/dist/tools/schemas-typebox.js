...
const HARNESS_IDS = ["cursor", "claude_code", "codex", "pi"];
...
export const typeboxSchemas = {
    ...
    list_agents: Type.Object({
        include: Type.Optional(Type.Union([Type.Literal("external"), Type.Literal("internal"), Type.Literal("all")])),
    }),
    ...
    workflow_confirm: Type.Object({
        ...
        gate_type: Type.Optional(Type.Union([
            Type.Literal("skeptic"),
            Type.Literal("plan"),
            Type.Literal("design"),
            Type.Literal("discovery"),
        ])),
        verdict: Type.Optional(Type.Union([Type.Literal("proceed"), Type.Literal("revise"), Type.Literal("conditional_go")])),
