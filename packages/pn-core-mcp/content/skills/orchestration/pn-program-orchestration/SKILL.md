...
description: "Conductor for feature_program: split ≥2 vertical slices, DAG, merge queue. Use when the user asks for parallel slices or /pn-program — not for a single-slice feature."
---
