---
name: pn-a2a-interop
description: "Agent2Agent (A2A) interop with external frameworks. Use when composing agents across orgs or stacks (LangGraph, CrewAI) — not for in-process pnCore specialists."
---
